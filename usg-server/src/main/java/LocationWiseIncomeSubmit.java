...
//                String result = new ConsolidateIncomeBudgetManager().save(fc, loginUserId);
                ...
                logger.info(Common.getLogMsg("LocationWiseIncomeSubmit", ApplicationConstants.AUTHENTICATION, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            ...
            logger.info(Common.getLogMsg("LocationWiseIncomeSubmit", ApplicationConstants.AUTHENTICATION, ApplicationConstants.HTTP_STATUS_EXCEPTION));
        } finally {
            out.close();
        }
    }
