 ...
 * @author user
 */
public class PensionAssociationService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                //System.out.println("converted--------------------------z."+cla);
                String result = new PensionAssociationManager().save(cla,userid);
                  //System.out.println("final-------------------------z."+result);
