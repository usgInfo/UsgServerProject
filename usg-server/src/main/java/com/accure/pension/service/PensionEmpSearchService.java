 ...
 * @author user
 */
public class PensionEmpSearchService extends HttpServlet {

    Logger logger = Logger.getLogger(PensionEmpSearchService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                //Search Accordingly the Search criteria given                
//                if (!condition.equalsIgnoreCase("yes")) {

                    Type type = new TypeToken<PensionEmployeeDetails>() {
                    }.getType();
                    PensionEmployeeDetails employeeSearch = new Gson().fromJson(employeeSearchJSON1, type);

                    resultEmployeeJson = new PensionManager().EmpSearch(employeeSearch);
//                } //Getting All Data
//                else {
