 ...
 * @author user
 */
public class PensionBankUpdateService extends HttpServlet {

    Logger logger = Logger.getLogger(PensionBankUpdateService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                String classJson = request.getParameter("pensionbankupdateJson");
                String id = request.getParameter("id");
                String userid = request.getParameter("userid");
                Type type = new TypeToken<PensionBank>() {
                }.getType();
                PensionBank cla = new Gson().fromJson(classJson, type);
                //String association = request.getParameter("assJson");

                String status = new PensionBankManager().update(cla, id, userid);
                ...
                logger.info(Common.getLogMsg("PensionBankUpdateService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
            ...
            logger.error(Common.getLogMsg("PensionBankUpdateService", ApplicationConstants.ERROR, stack.toString()));
