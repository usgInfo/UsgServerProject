 ...
 * @author user
 */
public class PensionEmployUpdateService extends HttpServlet {
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                //if (authorized) {
                    ...
                    com.accure.pension.dto.PensionEmployeeDetails employee = new Gson().fromJson(gradeJson, type);
                    employee.setImageAvailable(isImageAvailable);
                    String resultid = request.getHeader("employeeId");
                    String result = new PensionManager().update(employee, resultid, userId);
