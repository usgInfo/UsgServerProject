 ...
 * @author upendra
 */
public class EmpAutoSalarySearchService extends HttpServlet {

    Logger logger = Logger.getLogger(EmpAutoSalarySearchService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                String resultJson = new AutoSalaryProcessManager().search(ddo, month, year);
                ...
                if (resultJson != null && !resultJson.isEmpty()) {
                    ...
                    logger.info(Common.getLogMsg("EmpAutoSalarySearchService", ApplicationConstants.VIEW, ApplicationConstants.SUCCESS));
                }
