 ...
 * @author user
 */
public class GetLoanPymentDetailsService extends HttpServlet {
     ...
     try {
            ...
            if (SessionManager.checkUserSession(session))
            {
                ...
                String applyNo = request.getParameter("applyNo");
                 String resultJson =new Gson().toJson(new LoanRecoveryManager().getBalLoanAmount(ecode,loanType,applyNo));
