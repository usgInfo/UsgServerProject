 ...
 * @author upendra
 */
public class SaveEmpAttendanceService extends HttpServlet {

    Logger logger = Logger.getLogger(SaveEmpAttendanceService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    String attendanceJson = request.getParameter("processAttendance");
                    String month = request.getParameter("month");
                    //System.out.println("month" + month);
                    String year = request.getParameter("year");
                    String ddo = request.getParameter("ddo");
                    boolean result = EmpAttendanceManager.employeeleavetransactionJoing(attendanceJson, month, year, ddo);
                    ...
                    logger.info(Common.getLogMsg("SaveEmpAttendanceService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
