 ...
 * @author upendra
 */
public class EmployeeAttendanceSearchService extends HttpServlet {

    Logger logger = Logger.getLogger(EmployeeAttendanceSearchService.class);
            ...
            if (SessionManager.checkUserSession(session)) {
               ...
               String action = request.getParameter("action");
                if (ApplicationConstants.EMPLOYEE_VIEW.equals(action)) {
                    ...
                    EmpAttendanceManager empManager=new EmpAttendanceManager();
                    HashMap outputJson = empManager.getSearchResult(employeeJson);
                    if (outputJson != null) {
