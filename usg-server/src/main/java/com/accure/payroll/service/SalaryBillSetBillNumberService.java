 ...
 * @author ankur
 */
public class SalaryBillSetBillNumberService extends HttpServlet {

    Logger logger = Logger.getLogger(SalaryBillSetBillNumberService.class);
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    status = new SalaryBillCreationManager().setBillNumber(empObjId);
                    ...
                    logger.info(Common.getLogMsg("SalaryBillSetBillNumberService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
