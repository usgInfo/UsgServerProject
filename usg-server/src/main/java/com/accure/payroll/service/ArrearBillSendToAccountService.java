 ...
 * @author user
 */
public class ArrearBillSendToAccountService extends HttpServlet {

    Logger logger = Logger.getLogger(AttendanceUnprocessService.class);
    String privilege = ApplicationConstants.PV_ARREAR_BILL_UPDATE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    status = new ArrearBillCreationManager().updateSendToAccountsTrue(empListJson);
                    ...
                    logger.info(Common.getLogMsg("ArrearBillSendToAccountService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
