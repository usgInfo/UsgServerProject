 ...
 * @author deepak2310
 */
public class DeductionDetailsReportService extends HttpServlet {

    Logger logger = Logger.getLogger(DeductionDetailsReportService.class);
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (ApplicationConstants.DEPARTMENT.equals(action)) {
                    ...
                    if (departmentList != null) {
                        ...
                        logger.info(Common.getLogMsg("DeductionDetailsReportService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                    }
                    ...
                    if (designationList != null) {
                        ...
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                        logger.info(Common.getLogMsg("DeductionDetailsReportService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
