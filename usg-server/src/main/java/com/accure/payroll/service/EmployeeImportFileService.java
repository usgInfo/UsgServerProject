 ...
 * @author user
 */
public class EmployeeImportFileService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        filePath = contextPath + "EmployeeImportFiles";
            ...
            try {
                ...
                while (i.hasNext()) {
                    ...
                    if (!fi.isFormField()) {
                        ...
                        String result = EmployeeImportData.importDataToEmployee(file.getAbsoluteFile());
                        ...
                        if (result.equalsIgnoreCase("success")) {
                            ...
                            response.setContentType("text/plain");
                            response.setCharacterEncoding("UTF-8");
                            response.getWriter().write(ApplicationConstants.HTTP_STATUS_FAIL);
