 ...
 * @author user
 */
@WebServlet(name = "SearchEmplForArrearEditProcessService", urlPatterns = {"/Payrl/PayrlDetls/Arrear/SearchEmplForArrearEditProcess"})
public class SearchEmplForArrearEditProcessService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
               ...
               String action = request.getParameter("action");
                if (ApplicationConstants.EMPLOYEE_VIEW.equals(action)) {
                    ...
                    String outputJson = new EmployeeArrearManager().getSearchResultFromArrearProcess(employeeJson);
                    if (outputJson != null) {
                        ...
                        //logger.info(Common.getLogMsg("EmployeeAttendanceSearchService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                        ...
                        //logger.info(Common.getLogMsg("EmployeeAttendanceSearchService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                    }
                }
            ...
            //logger.error(Common.getLogMsg("EmployeeAttendanceSearchService", ApplicationConstants.ERROR, stack.toString()));
