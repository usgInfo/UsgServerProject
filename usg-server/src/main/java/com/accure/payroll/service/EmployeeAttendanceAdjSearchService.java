 ...
 * @author user
 */
public class EmployeeAttendanceAdjSearchService extends HttpServlet {
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                    ...
                    if (ApplicationConstants.EMPLOYEE_VIEW.equals(action)) {
                        ...
                        HashMap outputJson = new EmpAttendanceManager().getSearchResultAttendaceAdj(employeeJson);
                        if (outputJson != null) {
