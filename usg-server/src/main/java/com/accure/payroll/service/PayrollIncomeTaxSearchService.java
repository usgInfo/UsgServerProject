 ...
 * @author user
 */
public class PayrollIncomeTaxSearchService extends HttpServlet {

      Logger logger = Logger.getLogger(PayrollIncomeTaxSearchService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
               ...
               String action = request.getParameter("action");
                if (ApplicationConstants.EMPLOYEE_VIEW.equals(action)) {
                    ...
                    HashMap outputJson = new IncomeTaxManager().getSearchResult(employeeJson);
                    if (outputJson != null) {
                        ...
                        logger.info(Common.getLogMsg("PayrollIncomeTaxSearchService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                        ...
                        logger.info(Common.getLogMsg("PayrollIncomeTaxSearchService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                    }
                }
            ...
            logger.error(Common.getLogMsg("PayrollIncomeTaxSearchService", ApplicationConstants.ERROR, stack.toString()));
