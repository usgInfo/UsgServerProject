...
import com.accure.payroll.manager.MonthlySalaryStatusReportManager;
 ...
 * @author upendra
 */
public class MonthlySalaryStatusReport extends HttpServlet {

    Logger logger = Logger.getLogger(MonthlySalaryStatusReport.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ByteArrayOutputStream baos = new MonthlySalaryStatusReportManager().mothlySalaryStatusStatement(month, year,contextPath,fin);
            if (baos != null) {
