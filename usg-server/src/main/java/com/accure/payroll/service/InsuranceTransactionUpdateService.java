 ...
 * @author Shwetha T S
 */
public class InsuranceTransactionUpdateService extends HttpServlet {

    Logger logger = Logger.getLogger(InsuranceTransactionUpdateService.class);
    String privilege = ApplicationConstants.PV_INSURANCE_TRANSACTION_UPDATE;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    String classJson = request.getParameter("object");
                    ...
                    String result = new InsuranceTransactionManager().update(cla, id, userid);
                    ...
                    if (result.equalsIgnoreCase(ApplicationConstants.RETIREMENT_DATE_VALIDATE_FOR_INSC_TRANS)) {
                        ...
                        logger.info(Common.getLogMsg("InsuranceTransactionUpdateService", ApplicationConstants.VIEW, ApplicationConstants.FAIL));
                    ...
                    logger.info(Common.getLogMsg("InsuranceTransactionUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                } else {
                    ...
                    logger.info(Common.getLogMsg("InsuranceTransactionUpdateService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
                request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_INVALID_SESSION);
                out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_INVALID_SESSION));
                logger.info(Common.getLogMsg("InsuranceTransactionUpdateService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
            ...
            logger.error(Common.getLogMsg("InsuranceTransactionUpdateService", ApplicationConstants.ERROR, stack.toString()));
