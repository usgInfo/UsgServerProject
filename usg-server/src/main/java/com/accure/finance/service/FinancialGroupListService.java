 ...
 * @author user
 */
public class FinancialGroupListService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                String resultGroupJson = new GroupManager().fetchAll();
                //System.out.println(resultGroupJson);
                if (resultGroupJson != null && !resultGroupJson.isEmpty()) {
                    request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                    out.write((resultGroupJson));
//                      logger.info(Common.getLogMsg("GroupManagerViewAllService", ApplicationConstants.VIEW, ApplicationConstants.SUCCESS));
                } else {
