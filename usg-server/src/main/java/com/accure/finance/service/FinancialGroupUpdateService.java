 ...
 * @author user
 */
public class FinancialGroupUpdateService extends HttpServlet {

    String privilege = ApplicationConstants.PV_GROUP_UPDATE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    Group group = new Gson().fromJson(groupJson, type);
                    String groupId = request.getParameter("gId");
                    String userId = request.getParameter("userId");
                    String result = new GroupManager().update(group, groupId, userId);
                    ...
                    logger.info(Common.getLogMsg("FinancialGroupUpdateService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
