 ...
 * @author upendra
 */
public class SaveSubMinorHeadService extends HttpServlet {

    Logger logger = Logger.getLogger(SaveSubMinorHeadService.class);
    String privilege = ApplicationConstants.PV_SUB_MINOR_CODE_CREATE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String result = new SubMinorHeadManager().saveSubMinorHead(head, code, userId);
                    ...
                    logger.info(Common.getLogMsg("SaveSubMinorHeadService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
                request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_INVALID_SESSION);
                out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_INVALID_SESSION));
                logger.info(Common.getLogMsg("SaveSubMinorHeadService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("SaveSubMinorHeadService", ApplicationConstants.ERROR, stack.toString()));
