...
import com.accure.finance.manager.BetweenDatesDepositManager;
 ...
 * @author accure
 */
public class BetweenDatesDepositReportService extends HttpServlet {

    Logger logger = Logger.getLogger(BetweenDatesDepositReportService.class);
    /**
...
//            String voucherdata = request.getParameter("voucherList");
           ...
           ServletContext servletContext = getServletContext();
            ...
            if (baos != null) {
                ...
                ut.mergeDocuments();
                ut.setDestinationFileName("DepositReport.pdf");
            ...
            logger.error(Common.getLogMsg("BetweenDatesDepositReportService", ApplicationConstants.ERROR, stack.toString()));
