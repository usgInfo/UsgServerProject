 ...
 * @author upendra
 */
public class DeleteGovtBudgetHeadService extends HttpServlet {

    Logger logger = Logger.getLogger(DeleteGovtBudgetHeadService.class);
    String privilege = ApplicationConstants.PV_GOVERNMENT_BUDGET_HEAD_DELETE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new GovtBudgetHeadManager().deleteGBH(id, userId);
                    ...
                    logger.info(Common.getLogMsg("DeleteGovtBudgetHeadService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
                request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_INVALID_SESSION);
                out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_INVALID_SESSION));
                logger.info(Common.getLogMsg("DeleteGovtBudgetHeadService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("DeleteGovtBudgetHeadService", ApplicationConstants.ERROR, stack.toString()));
