 ...
 * @author user
 */
public class PartyMasterDelete extends HttpServlet {

    //String privilege = ApplicationConstants.PV_DELETE_PARTY_MASTER;
    Logger logger = Logger.getLogger(PartyMasterDelete.class);
...
//                if (authorized) {
                ...
                String status = new PartyMasterManager().delete(id, userid);
                ...
                if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                    ...
                    logger.info(Common.getLogMsg("PartyMasterDelete", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
...
//                }
                ...
                logger.info(Common.getLogMsg("PartyMasterDelete", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            ...
            logger.error(Common.getLogMsg("PartyMasterDelete", ApplicationConstants.ERROR, stack.toString()));
