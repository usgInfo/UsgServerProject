 ...
 * @author upendra
 */
public class SaveMajorHeadService extends HttpServlet {

    Logger logger = Logger.getLogger(SaveMajorHeadService.class);
    String privilege = ApplicationConstants.PV_MAJOR_CODE_CREATE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String result = new MajorHeadManager().saveMajorHead(head, code, userId);
                    ...
                    logger.info(Common.getLogMsg("SaveMajorHeadService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
                request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_INVALID_SESSION);
                out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_INVALID_SESSION));
                logger.info(Common.getLogMsg("SaveMajorHeadService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("SaveMajorHeadService", ApplicationConstants.ERROR, stack.toString()));
