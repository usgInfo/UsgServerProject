...
import com.accure.finance.manager.BetweenDatesBankBookManager;
 ...
 * @author accure
 */
public class BetweenDatesBankBookReportService extends HttpServlet {

    Logger logger = Logger.getLogger(BetweenDatesBankBookReportService.class);
...
//            ByteArrayOutputStream baos = new BetweenDatesBankBookManager().bankBookReport(fromDate, toDate, voucherdata, contextPath);
            ByteArrayOutputStream baos = new BetweenDatesBankBookManager().bankBookReport(fromDate, toDate, voucherdata, ledger, contextPath, fin);
            if (baos != null) {
                PDFMergerUtility ut = new PDFMergerUtility();
                ut.addSource(new ByteArrayInputStream(baos.toByteArray()));
                ut.setDestinationStream(out);
                ut.mergeDocuments();
                ut.setDestinationFileName("BankBookReport.pdf");
            ...
            logger.error(Common.getLogMsg("BetweenDatesBankBookReportService", ApplicationConstants.ERROR, stack.toString()));
