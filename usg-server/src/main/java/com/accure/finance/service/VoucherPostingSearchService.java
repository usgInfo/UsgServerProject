 ...
 * @author user
 */
public class VoucherPostingSearchService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                String resultJson = new VoucherPostingManager().Search(voucherType, fromDate, toDate, DDO, location, fundType, budgetHead, manualVoucherNo, voucherAmount);
