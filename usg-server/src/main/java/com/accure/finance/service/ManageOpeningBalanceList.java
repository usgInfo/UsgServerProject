 ...
 * @author accure
 */
public class ManageOpeningBalanceList extends HttpServlet {

    Logger logger = Logger.getLogger(ManageOpeningBalanceList.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                manageOpeningBalanceList = new ManageOpeningBalanceManager().manageOpeningBalanceList();
                if (manageOpeningBalanceList != null && manageOpeningBalanceList.size() > 0) {
                    ...
                    logger.info(Common.getLogMsg("ManageOpeningBalanceList", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                    ...
                    logger.info(Common.getLogMsg("ManageOpeningBalanceList", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                }
            } else {
            ...
            logger.error(Common.getLogMsg("ManageOpeningBalanceList", ApplicationConstants.ERROR, stack.toString()));
        } finally {
            out.close();
        }
    }
