 ...
 * @author upendra
 */
public class UpdateGovtBudgetHeadManagerService extends HttpServlet {

    Logger logger = Logger.getLogger(UpdateGovtBudgetHeadManagerService.class);
    String privilege = ApplicationConstants.PV_GOVERNMENT_BUDGET_HEAD_UPDATE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String result = new GovtBudgetHeadManager().updateGovtBudgetHead(bank, id, userId);
                    ...
                    logger.info(Common.getLogMsg("UpdateGovtBudgetHeadManagerService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
