 ...
 * @author accure
 */
public class FetchDateWiseCashBookStatement extends HttpServlet {

    Logger logger = Logger.getLogger(FetchDateWiseCashBookStatement.class);
...
//        OutputStream out = null;
        try {
            ...
            ByteArrayOutputStream outputJson = new CashBookReportManager().cashBookPdfStatement(date, voucherdata, ledger, contextPath, fin);
            ...
            logger.error(Common.getLogMsg("FetchDateWiseCashBookStatement", ApplicationConstants.ERROR, stack.toString()));
