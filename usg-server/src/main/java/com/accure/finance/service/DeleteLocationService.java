 ...
 * @author deepak2310
 */
public class DeleteLocationService extends HttpServlet {

    Logger logger = Logger.getLogger(DeleteLocationService.class);
    String privilege = ApplicationConstants.PV_DELETE_LOCATION;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new LocationManager().deleteLocation(locationId, currentUserLogin);
            ...
            out.write(new Gson().toJson(new Common().onFailure(ApplicationConstants.HTTP_STATUS_EXCEPTION, ApplicationConstants.LOCATION_DELETION_FAILED, "")));
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("DeleteLocationService", ApplicationConstants.ERROR, stack.toString()));
