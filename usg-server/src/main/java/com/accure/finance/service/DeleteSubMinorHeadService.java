 ...
 * @author accure
 */
public class DeleteSubMinorHeadService extends HttpServlet {

    Logger logger = Logger.getLogger(DeleteSubMinorHeadService.class);
    String privilege = ApplicationConstants.PV_SUB_MINOR_CODE_DELETE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new SubMinorHeadManager().deleteSubMinorHead(id, userId);
                    ...
                    logger.info(Common.getLogMsg("DeleteSubMinorHeadService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
