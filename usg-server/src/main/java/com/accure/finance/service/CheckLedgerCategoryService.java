 ...
 * @author accure
 */
public class CheckLedgerCategoryService extends HttpServlet {
Logger logger = Logger.getLogger(CheckLedgerCategoryService.class);
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                List<LedgerCategory> ledgerList = null;
                ledgerList = new ManageOpeningBalanceManager().checkLedgerIsIncomeOrBudgetCategory(ledger);
//                LedgerCategory ledgerList = new ManageOpeningBalanceManager().checkLedgerCategoryIsIncomeOrBudget(ledger);
                if (ledgerList != null) {
                    ...
                    logger.info(Common.getLogMsg("CheckLedgerCategoryService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                    ...
                    logger.info(Common.getLogMsg("CheckLedgerCategoryService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                }
            } else {
            ...
            logger.error(Common.getLogMsg("CheckLedgerCategoryService", ApplicationConstants.ERROR, stack.toString()));
        } finally {
            out.close();
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckLedgerCategoryService.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
