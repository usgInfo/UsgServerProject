 ...
 * @author deepak2310
 */
public class UpdateLedgerService extends HttpServlet {

    Logger logger = Logger.getLogger(UpdateLedgerService.class);
    String privilege = ApplicationConstants.PV_LEDGER_UPDATE;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    String ledgerJson = request.getParameter("updateledgerjson");
                    ...
                    String status = new LedgerManager().updateLedgerInfo(ledger, userId, ledgerId);
                    ...
                    logger.info(Common.getLogMsg("UpdateLedgerService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
            ...
            out.write(new Gson().toJson(new Common().onFailure(ApplicationConstants.HTTP_STATUS_EXCEPTION, ApplicationConstants.LEDGER_UPDATION_FAILED, "")));
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("UpdateLedgerService", ApplicationConstants.ERROR, stack.toString()));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateLedgerService.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
