 ...
 * @author deepak2310
 */
public class GroupMasterListService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                groupList = new GroupManager().fetchAllGroup();
                if (groupList != null && groupList.size() > 0) {
                    out.write(new Gson().toJson(new Common().onSuccess(ApplicationConstants.HTTP_STATUS_SUCCESS, ApplicationConstants.GROUP_MASTER_LIST, groupList)));
                ...
                } else if (groupList == null || groupList.isEmpty()) {
                    ...
                    out.write(new Gson().toJson(new Common().onFailure(ApplicationConstants.HTTP_STATUS_FAIL, ApplicationConstants.GROUP_MASTER_LIST_FAILED, groupList)));
