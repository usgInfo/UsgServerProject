 ...
 * @author deepak2310
 */
public class DeleteDDOService extends HttpServlet {

    Logger logger = Logger.getLogger(DeleteDDOService.class);
    String privilege = ApplicationConstants.PV_DELETE_DDO;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new DDOManager().deleteDDO(ddoId, currentUserLogin);
            ...
            out.write(new Gson().toJson(new Common().onFailure(ApplicationConstants.HTTP_STATUS_EXCEPTION, ApplicationConstants.DDO_DELETION_FAILED, "")));
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("DDODeleteService", ApplicationConstants.ERROR, stack.toString()));
