 ...
 * @author upendra
 */
public class UpdateMinorHeadService extends HttpServlet {

    Logger logger = Logger.getLogger(UpdateMinorHeadService.class);
    String privilege = ApplicationConstants.PV_MINOR_CODE_UPDATE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String result = new MinorHeadManager().updateMinorHead(head, code, id, userId);
                    ...
                    logger.info(Common.getLogMsg("UpdateMinorHeadService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
                request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_INVALID_SESSION);
                out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_INVALID_SESSION));
                logger.info(Common.getLogMsg("UpdateMinorHeadService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("UpdateMinorHeadService", ApplicationConstants.ERROR, stack.toString()));
