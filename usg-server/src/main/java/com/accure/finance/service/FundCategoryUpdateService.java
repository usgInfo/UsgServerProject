 ...
 * @author user
 */
public class FundCategoryUpdateService extends HttpServlet {

    Logger logger = Logger.getLogger(FundCategoryUpdateService.class);
    String privilege = ApplicationConstants.PV_FUND_CATEGORY_UPDATE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    FundCategory fundcategory = new Gson().fromJson(fundcategoryJson, type);
                    String fundcategoryId = request.getParameter("fcId");
                    String userId = request.getParameter("userId");
                    String result = new FundCategoryManager().update(fundcategory, fundcategoryId, userId);
                    ...
                    logger.info(Common.getLogMsg("FundCategoryUpdateService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
