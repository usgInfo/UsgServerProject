 ...
 * @author user
 */
public class FinancialGroupDeleteService extends HttpServlet {

    Logger logger = Logger.getLogger(FinancialGroupDeleteService.class);
    String privilege = ApplicationConstants.PV_GROUP_DELETE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new GroupManager().delete(groupId, userId);
                    ...
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("FinancialGroupDeleteService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                    ...
                    logger.info(Common.getLogMsg("FinancialGroupDeleteService", ApplicationConstants.DELETE, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
                request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_INVALID_SESSION);
                out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_INVALID_SESSION));
                logger.info(Common.getLogMsg("FinancialGroupDeleteService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("FinancialGroupDeleteService", ApplicationConstants.ERROR, stack.toString()));
