 ...
 * @author user
 */
public class FinancialFundCategoryDeleteService extends HttpServlet {

    Logger logger = Logger.getLogger(FinancialFundCategoryDeleteService.class);
    String privilege = ApplicationConstants.PV_FUND_CATEGORY_DELETE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String fundcategoryId = request.getParameter("fcId");
                    String userId = request.getParameter("userId");
                    String status = new FundCategoryManager().delete(fundcategoryId, userId);
//                
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("FinancialFundCategoryDeleteService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                    ...
                    logger.info(Common.getLogMsg("FinancialFundCategoryDeleteService", ApplicationConstants.DELETE, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
