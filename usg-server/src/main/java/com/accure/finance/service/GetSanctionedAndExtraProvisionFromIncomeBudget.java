 ...
 * @author accure
 */
public class GetSanctionedAndExtraProvisionFromIncomeBudget extends HttpServlet {
Logger logger = Logger.getLogger(GetSanctionedAndExtraProvisionFromIncomeBudget.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                List<CreateIncomeBudget> ledgerList = null;
                ledgerList = new ManageOpeningBalanceManager().getSanctionedAndExtraProvisionAmount(ledger, finYear);
//                LedgerCategory ledgerList = new ManageOpeningBalanceManager().checkLedgerCategoryIsIncomeOrBudget(ledger);
                if (ledgerList != null) {
                    ...
                    logger.info(Common.getLogMsg("GetSanctionedAndExtraProvisionFromIncomeBudget", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                    ...
                    logger.info(Common.getLogMsg("GetSanctionedAndExtraProvisionFromIncomeBudget", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                }
            } else {
            ...
            logger.error(Common.getLogMsg("GetSanctionedAndExtraProvisionFromIncomeBudget", ApplicationConstants.ERROR, stack.toString()));
        } finally {
            out.close();
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GetSanctionedAndExtraProvisionFromIncomeBudget.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
