 ...
 * @author accure
 */
public class CashBookReportManager {

    public String getLedgerCodeAndLedgerName(String ledgerId, String ledgerName) throws Exception {

        HashMap<String, String> map = new HashMap<String, String>();
        map.put(ApplicationConstants.STATUS, ApplicationConstants.ACTIVE);
        map.put("governmentLedgerCode", ledgerId);

        String result = DBManager.getDbConnection().fetchAllRowsByConditions(ApplicationConstants.LEDGER_CODE_TABLE, map);
        ...
        return ledgerName + "(" + ledgerCode.getLedgerCode() + ")";
    }

    public ByteArrayOutputStream cashBookPdfStatement(String date, String voucherdata, String ledger, String path, String fin) throws DocumentException, FileNotFoundException, Exception {
...
//financial year
        ...
        CashBookReportManager.RoundRectangle roundRectangle = new CashBookReportManager.RoundRectangle();
        ...
        PdfPCell cell = new PdfPCell(new Phrase("Cash Book", font1));
        cell.setColspan(4);
        cell.setRowspan(5);
