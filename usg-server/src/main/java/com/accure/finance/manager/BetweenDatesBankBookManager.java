 ...
 * @author accure
 */
public class BetweenDatesBankBookManager {

    public ByteArrayOutputStream bankBookReport(String fromDate, String toDate, String voucherdata, String ledger, String path, String fin) throws DocumentException, FileNotFoundException, Exception {
