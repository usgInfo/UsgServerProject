 ...
 * @author accure
 */
public class BetweenDatesCashBookManager {

    public ByteArrayOutputStream betweenDatesCashBookPdfStatement(String fromDate, String toDate, String voucherdata, String ledger, String path, String fin) throws DocumentException, FileNotFoundException, Exception {
        ...
        if (ledgerJson == null || ledgerJson.isEmpty()) {
            ...
            openingBalance = roundTwoDecimals(0.00);
        } else {
        ...
        if (fromDate != null && fromDate != "" && !fromDate.isEmpty()) {
            ...
            contraSearchQuery = contraSearchQuery + " and cv.voucherDateInMilliSecond>=" + fromVD;
...
//financial year
        ...
        BetweenDatesCashBookManager.RoundRectangle roundRectangle = new BetweenDatesCashBookManager.RoundRectangle();
        ...
        if (merged == null || merged.size() > 0) {
            PdfPTable table5 = new PdfPTable(9); //s
