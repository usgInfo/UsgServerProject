 ...
 * @author accure
 */
public class BetweenDatesLedgerBookManager {

    public ByteArrayOutputStream betweenDatesLedgerBookReport(String fromDate, String toDate, String voucherdata, String ledger, String path, String fin) throws DocumentException, FileNotFoundException, Exception {
...
//            openingBalance = 0.00;
        ...
        float[] ninthcolumnwidth = {1f, 1f, 1.5f, 1f, 1.5f, 1f, 1f, 1f, 1.5f};
...
//            table6cell6.setBorder(Rectangle.NO_BORDER);
                ...
                double value = roundTwoDecimals(Double.parseDouble(text));
                String textx = roundTwoDecimalPoints(value);
                totalDrAmount = roundTwoDecimals(totalDrAmount + value);
...
//            table6cell7.setBorder(Rectangle.NO_BORDER);
                ...
                double value1 = roundTwoDecimals(Double.parseDouble(text1));
                String texty = roundTwoDecimalPoints(value1);
                totalCrAmount = roundTwoDecimals(totalCrAmount) + value1;
