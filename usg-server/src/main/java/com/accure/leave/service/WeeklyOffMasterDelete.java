 ...
 * @author user
 */
//public class WeeklyOffMasterDelete extends HttpServlet {
//Logger logger = Logger.getLogger(WeeklyOffMasterDelete.class);
//    /**
...
//               
//                boolean result = new WeeklyOffMasterManager().deleteWeekOffMaster(Id);
//                
//                 if (result == true) {
