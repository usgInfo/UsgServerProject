 ...
 * @author user
 */
public class LeaveFinancialYearDelete extends HttpServlet {

    Logger logger = Logger.getLogger(LeaveFinancialYearDelete.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                String status = new FinancialYearManager().delete(id, userId);
                ...
                if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                    ...
                    logger.info(Common.getLogMsg("LeaveFinancialYearDelete", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                    ...
                    logger.info(Common.getLogMsg("LeaveFinancialYearDelete", ApplicationConstants.DELETE, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            }
        } catch (Exception ex) {
            ex.printStackTrace();
            ...
            logger.error(Common.getLogMsg("LeaveFinancialYearDelete", ApplicationConstants.ERROR, stack.toString()));
