 ...
 * @author user
 */
public class LeaveTypeService extends HttpServlet {

    Logger logger = Logger.getLogger(LeaveTypeService.class);
    String privilege = ApplicationConstants.PV_LEAVE_TYPE_CREATE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    LeaveTypeMaster fc = new Gson().fromJson(objJson, type);
                    String result = new LeaveTypeManager().save(fc, loginUserId);
                    if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                        out.write(new Gson().toJson(result));
                        logger.info(Common.getLogMsg("LeaveTypeService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                        ...
                        logger.info(Common.getLogMsg("LeaveTypeService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                    ...
                    logger.info(Common.getLogMsg("LeaveTypeService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.INVALID_SESSION));
                }
            } else {
            ...
            logger.info(Common.getLogMsg("LeaveTypeService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.HTTP_STATUS_EXCEPTION));
        } finally {
            out.close();
        }
    }
