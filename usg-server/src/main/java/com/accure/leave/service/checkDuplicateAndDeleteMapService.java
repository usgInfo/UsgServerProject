 ...
 * @author user
 */
public class checkDuplicateAndDeleteMapService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                boolean result = new LeaveTypeManager().checkDeleteMapForLeaveTypeDetails(employeeCategory, natureType, id);
                if (result == true) {
