 ...
 * @author user
 */
public class HolidayTypeMasterUpdateService extends HttpServlet {

    Logger logger = Logger.getLogger(HolidayTypeMasterUpdateService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                HolidayTypeMaster obj = new Gson().fromJson(objJson, type);
                String objId = request.getParameter("objId");
                String userId = request.getParameter("userId");
                String result = new HolidayTypeMasterManager().updateHolidaysTypeMaster(obj, objId, userId);
                if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                    request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                    out.write(new Gson().toJson(result));
                    logger.info(Common.getLogMsg("HolidayTypeMasterUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                    ...
                    logger.info(Common.getLogMsg("HolidayTypeMasterUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
