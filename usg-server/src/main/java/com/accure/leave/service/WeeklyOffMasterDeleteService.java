 ...
 * @author user
 */
public class WeeklyOffMasterDeleteService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_WEEKLY_OFF_MASTER;
    Logger logger = Logger.getLogger(WeeklyOffMasterDeleteService.class);
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String result = new WeeklyOffMasterManager().deleteWeekOffMaster(Id, userId);

                    if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                        out.write(new Gson().toJson(result));
                        logger.info(Common.getLogMsg("WeeklyOffMasterDeleteService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                        ...
                        logger.info(Common.getLogMsg("WeeklyOffMasterDeleteService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("WeeklyOffMasterDeleteService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("WeeklyOffMasterDeleteService", ApplicationConstants.ERROR, stack.toString()));
