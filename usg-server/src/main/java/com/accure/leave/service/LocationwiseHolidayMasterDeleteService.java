 ...
 * @author user
 */
public class LocationwiseHolidayMasterDeleteService extends HttpServlet {

    Logger logger = Logger.getLogger(LocationwiseHolidayMasterDeleteService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                boolean result = new LocationwiseHolidayMasterManager().deleteLocationwiseHolidayMaster(Id);
