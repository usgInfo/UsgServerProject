 ...
 * @author User
 */
public class LeaveWorkFlowMasterDeleteService extends HttpServlet {
    Logger logger = Logger.getLogger(LeaveWorkFlowMasterDeleteService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {HttpSession session = request.getSession(false);
            if (SessionManager.checkUserSession(session)) {
                ...
                boolean result1 = new LeaveWorkFlowMasterManager().deleteLeaveWorkFlowMaster(Id);
