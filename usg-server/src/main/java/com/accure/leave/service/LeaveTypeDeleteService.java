 ...
 * @author Asif
 */
public class LeaveTypeDeleteService extends HttpServlet {

    Logger logger = Logger.getLogger(LeaveTypeDeleteService.class);
    String privilege = ApplicationConstants.PV_LEAVE_TYPE_DELETE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String result = new LeaveTypeManager().delete(Id, loginUserId);
                   if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                        out.write(new Gson().toJson(result));
                        logger.info(Common.getLogMsg("LeaveTypeDeleteService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                        ...
                        logger.info(Common.getLogMsg("LeaveTypeDeleteService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
            ...
            logger.error(Common.getLogMsg("LeaveTypeDeleteService", ApplicationConstants.ERROR, stack.toString()));
