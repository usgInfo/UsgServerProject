 ...
 * @author user
 */
public class CommonHolidaysMasterViewAllService extends HttpServlet {

     Logger logger = Logger.getLogger(CommonHolidaysMasterViewAllService.class);
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                String resultJson = new CommonHolidaysMasterManager().ViewAllCommonHolidaysMaster();
