 ...
 * @author 
 */
public class LeaveTypeUpdateService extends HttpServlet {

    Logger logger = Logger.getLogger(LeaveTypeUpdateService.class);
    String privilege = ApplicationConstants.PV_LEAVE_TYPE_UPDATE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    LeaveTypeMaster obj = new Gson().fromJson(objJson, type);
                    String Id = request.getParameter("Id");
                    String result = new LeaveTypeManager().update(obj, Id, userId);
                    if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                        out.write(new Gson().toJson(result));
                        logger.info(Common.getLogMsg("LeaveTypeUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                        ...
                        logger.info(Common.getLogMsg("LeaveTypeUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                    ...
                    logger.info(Common.getLogMsg("LeaveTypeUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.INVALID_SESSION));
                }
            } else {
            ...
            logger.info(Common.getLogMsg("LeaveTypeUpdateService", ApplicationConstants.ERROR, ApplicationConstants.HTTP_STATUS_EXCEPTION));
