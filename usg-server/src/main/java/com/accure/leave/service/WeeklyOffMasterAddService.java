 ...
 * @author user
 */
public class WeeklyOffMasterAddService extends HttpServlet {

    String privilege = ApplicationConstants.PV_CREATE_WEEKLY_OFF_MASTER;
    Logger logger = Logger.getLogger(WeeklyOffMasterAddService.class);
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String Location = request.getParameter("weeklyOffLocation");
                    String userId = request.getParameter("userId");

                    Type type = new TypeToken<WeeklyOffMasterList>() {
                    }.getType();
                    WeeklyOffMasterList fc = new Gson().fromJson(objJson, type);
                    String result = new WeeklyOffMasterManager().save(fc, Location, userId);

                    if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                        out.write(new Gson().toJson(result));
                        logger.info(Common.getLogMsg("WeeklyOffMasterAddService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                        ...
                        logger.info(Common.getLogMsg("WeeklyOffMasterAddService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
