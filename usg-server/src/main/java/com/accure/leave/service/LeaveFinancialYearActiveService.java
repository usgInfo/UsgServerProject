 ...
 * @author user
 */
public class LeaveFinancialYearActiveService extends HttpServlet {

    Logger logger = Logger.getLogger(LeaveFinancialYearActiveService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                String finalDt = request.getParameter("finalDt");
                session.setAttribute("leaveCurrentFinancialYear", finalDt);
                String status = new FinancialYearManager().active(id, userId);
                ...
                if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                    ...
                    logger.info(Common.getLogMsg("LeaveFinancialYearActiveService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                    ...
                    logger.info(Common.getLogMsg("LeaveFinancialYearActiveService", ApplicationConstants.DELETE, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            }
        } catch (Exception ex) {
            ex.printStackTrace();
            ...
            logger.error(Common.getLogMsg("LeaveFinancialYearActiveService", ApplicationConstants.ERROR, stack.toString()));
