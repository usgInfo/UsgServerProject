 ...
 * @author user
 */
public class HolidayLocationMasterViewService extends HttpServlet {
Logger logger = Logger.getLogger(HolidayLocationMasterViewService.class);
    /**
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                String resultJson = new HolidayLocationMasterManager().ViewAllHolidayLocationMaster();
