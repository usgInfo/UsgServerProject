 ...
 * @author user
 */
public class HolidayLocationMasterUpdateService extends HttpServlet {
       ...
       response.setContentType("text/json;charset=UTF-8");
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                HolidayLocationMaster obj = new Gson().fromJson(objJson, type);
                String objId = request.getParameter("objId");
                //System.out.println("id--------------->"+objId);
                boolean result = new HolidayLocationMasterManager().updateHolidayLocationMaster(obj, objId);
                if (result == true) {
