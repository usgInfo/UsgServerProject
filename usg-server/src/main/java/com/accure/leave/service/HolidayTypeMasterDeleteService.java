 ...
 * @author user
 */
public class HolidayTypeMasterDeleteService extends HttpServlet {

    String privilege = ApplicationConstants.PV_HOLIDAY_TYPE_DELETE;
    Logger logger = Logger.getLogger(HolidayTypeMasterDeleteService.class);
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String result = new HolidayTypeMasterManager().deleteHolidayTypeMaster(Id, userId);

                    if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                        out.write(new Gson().toJson(result));
                        logger.info(Common.getLogMsg("HolidayTypeMasterDeleteService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                        ...
                        logger.info(Common.getLogMsg("HolidayTypeMasterDeleteService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("HolidayTypeMasterDeleteService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("HolidayTypeMasterDeleteService", ApplicationConstants.ERROR, stack.toString()));
