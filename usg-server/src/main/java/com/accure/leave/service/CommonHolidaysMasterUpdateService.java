 ...
 * @author user
 */
public class CommonHolidaysMasterUpdateService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                CommonHolidayMaster obj = new Gson().fromJson(objJson, type);
                String objId = request.getParameter("objId");
               String result = new CommonHolidaysMasterManager().updateCommonHolidaysMaster(obj, objId,userId);
                if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                    request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                    out.write(new Gson().toJson(result));
                    logger.info(Common.getLogMsg("CommonHolidaysMasterUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                    ...
                    logger.info(Common.getLogMsg("CommonHolidaysMasterUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
