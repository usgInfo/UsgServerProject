 ...
 * @author user
 */
public class HolidayTypeMasterViewAllService extends HttpServlet {
  Logger logger = Logger.getLogger(HolidayTypeMasterViewAllService.class);
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                String resultJson = new HolidayTypeMasterManager().ViewAllHolidayTypeMaster();
