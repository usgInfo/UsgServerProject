 ...
 * @author upendra
 */
public class DeleteSalutationService extends HttpServlet {

    Logger logger = Logger.getLogger(DeleteSalutationService.class);
    String privilege = ApplicationConstants.PV_DELETE_SALUTATION;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new SalutationManager().delete(id, loginUserId);
                    ...
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("DeleteSalutationService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("DeleteSalutationService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
            ...
            logger.error(Common.getLogMsg("DeleteSalutationService", ApplicationConstants.ERROR, stack.toString()));
