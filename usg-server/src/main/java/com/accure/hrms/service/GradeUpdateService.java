 ...
 * @author user
 */
public class GradeUpdateService extends HttpServlet {

    Logger logger = Logger.getLogger(GradeUpdateService.class);
    String privilege = ApplicationConstants.PV_UPDATE_GRADE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new GradeManager().update(grade, gradeId,userId);
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("GradeUpdateService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                        ...
                        logger.info(Common.getLogMsg("GradeUpdateService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
                    }
                } else {
                    ...
                    logger.info(Common.getLogMsg("GradeUpdateService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
                request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_INVALID_SESSION);
                out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_INVALID_SESSION));
