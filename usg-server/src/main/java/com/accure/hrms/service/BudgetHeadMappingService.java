 ...
 * @author accure
 */
public class BudgetHeadMappingService extends HttpServlet {

    Logger logger = Logger.getLogger(BudgetHeadMappingService.class);
    String privilege = ApplicationConstants.PV_CREATE_BUDGET_HEAD;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String bJson = request.getParameter("bJson");
                    String user = request.getParameter("userid");
                    Type type = new TypeToken<BudgetHeadMaster>() {
                    }.getType();
                    BudgetHeadMaster bhm = new Gson().fromJson(bJson, type);
                    String result = new BudgetHeadMappingManager().save(bhm, user);
                    if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                        out.write(new Gson().toJson(result));
                        logger.info(Common.getLogMsg("BudgetHeadMappingService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                        ...
                        logger.info(Common.getLogMsg("BudgetHeadMappingService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                    ...
                    logger.info(Common.getLogMsg("BudgetHeadMappingService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
