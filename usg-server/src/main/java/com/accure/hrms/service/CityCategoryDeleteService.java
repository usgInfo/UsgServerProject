 ...
 * @author user
 */
public class CityCategoryDeleteService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_CITY_CATEGORY;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new CityCategoryManager().delete(Id, userid);
                    ...
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("CityCategoryDeleteService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
