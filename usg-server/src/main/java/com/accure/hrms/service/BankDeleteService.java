 ...
 * @author user
 */
public class BankDeleteService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_BANK;
        ...
        /*try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    boolean result = new BankManager().deleteBank(bankId);
...
//                String status = new BankManager().deleteBank(id, currentUserLogin);
                String status = new BankManager().deleteBank(id,userId);
