 ...
 * @author accure
 */
public class FetchAllDdoMappingService extends HttpServlet {
 Logger logger = Logger.getLogger(FetchAllDdoMappingService.class);
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                String result = new DDODepartmentManager().viewAll(ddo);
