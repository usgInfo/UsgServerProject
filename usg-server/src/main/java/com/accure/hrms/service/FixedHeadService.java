 ...
 * @author Asif
 */
public class FixedHeadService extends HttpServlet {
    Logger logger = Logger.getLogger(FixedHeadService.class);
    String privilege = ApplicationConstants.PV_CREATE_FIXED_HEAD;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    FixedHead fc = new Gson().fromJson(objJson, type);
                    String result = new FixedHeadManager().save(fc, loginUserId);
                    if (result != null && !result.isEmpty()) {
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                        out.write(new Gson().toJson(result));
                        logger.info(Common.getLogMsg("FixedHeadService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                    ...
                    request.setAttribute("statuscode", ApplicationConstants.FAIL);
                        ...
                        logger.info(Common.getLogMsg("FixedHeadService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("FixedHeadService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            ...
            logger.info(Common.getLogMsg("FixedHeadService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.HTTP_STATUS_EXCEPTION));
        } finally {
            out.close();
        }
    }
