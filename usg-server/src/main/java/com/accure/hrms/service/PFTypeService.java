 ...
 * @author user
 */
public class PFTypeService extends HttpServlet {

    Logger logger = Logger.getLogger(PFTypeService.class);
    String privilege = ApplicationConstants.PV_CREATE_PF_TYPE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String result = new PFTypeManager().save(obj, loginUserId);
                    if (result != null && !result.isEmpty()) {
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                        out.write(new Gson().toJson(result));
                        logger.info(Common.getLogMsg("PFTypeService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                    ...
                    request.setAttribute("statuscode", ApplicationConstants.FAIL);
                        ...
                        logger.info(Common.getLogMsg("PFTypeService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("PFTypeService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            ...
            logger.info(Common.getLogMsg("PFTypeService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.HTTP_STATUS_EXCEPTION));
        } finally {
            out.close();
        }
    }
