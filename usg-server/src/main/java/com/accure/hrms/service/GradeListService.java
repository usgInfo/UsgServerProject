 ...
 * @author user
 */
public class GradeListService extends HttpServlet {
    Logger logger = Logger.getLogger(GradeListService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                String resultGradeJson = new GradeManager().fetchAll();
                //System.out.println(resultGradeJson);
                if (resultGradeJson != null && !resultGradeJson.isEmpty()) {
                    request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                    out.write((resultGradeJson));
//                      logger.info(Common.getLogMsg("GradeManagerViewAllService", ApplicationConstants.VIEW, ApplicationConstants.SUCCESS));
                } else {
