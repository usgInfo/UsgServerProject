 ...
 * @author accure
 */
public class DDODepartmentMappingService extends HttpServlet {

    Logger logger = Logger.getLogger(DDODepartmentMappingService.class);
    String privilege = ApplicationConstants.PV_CREATE_DDO_DEPARTMENT_MAPPING;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    String objJson = request.getParameter("ddoJson");
                    String userid = request.getParameter("userid");

                    Type type = new TypeToken<DdoDepartmentMap>() {
                    }.getType();
                    DdoDepartmentMap obj = new Gson().fromJson(objJson, type);

                    String result = new DDODepartmentManager().save(obj, userid);
                    if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                        out.write(new Gson().toJson(result));
                        logger.info(Common.getLogMsg("DDODepartmentMappingService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                        ...
                        logger.info(Common.getLogMsg("DDODepartmentMappingService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
