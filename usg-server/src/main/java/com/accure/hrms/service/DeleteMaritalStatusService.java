 ...
 * @author upendra
 */
public class DeleteMaritalStatusService extends HttpServlet {

    Logger logger = Logger.getLogger(DeleteMaritalStatusService.class);
    String privilege = ApplicationConstants.PV_DELETE_MARITIAL;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new MaritalStatusManager().delete(id, loginUserId);
                    ...
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("DeleteMaritalStatusService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("DeleteMaritalStatusService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
            ...
            logger.error(Common.getLogMsg("DeleteMaritalStatusService", ApplicationConstants.ERROR, stack.toString()));
