 ...
 * @author user
 */
public class PFTypeUpdateService extends HttpServlet {

    Logger logger = Logger.getLogger(PFTypeUpdateService.class);
    String privilege = ApplicationConstants.PV_UPDATE_PF_TYPE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    PFType obj = new Gson().fromJson(objJson, type);
                    String Id = request.getParameter("Id");
                String result = new PFTypeManager().update(obj, Id, userId);
               if (result != null && !result.isEmpty()) {
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                        out.write(new Gson().toJson(result));
                        logger.info(Common.getLogMsg("PFTypeUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                    ...
                    request.setAttribute("statuscode", ApplicationConstants.FAIL);
                        ...
                        logger.info(Common.getLogMsg("PFTypeUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("PFTypeUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.info(Common.getLogMsg("PFTypeUpdateService", ApplicationConstants.ERROR, ApplicationConstants.HTTP_STATUS_EXCEPTION));
