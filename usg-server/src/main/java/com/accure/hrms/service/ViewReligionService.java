 ...
 * @author upendra
 */
public class ViewReligionService extends HttpServlet {

    Logger logger = Logger.getLogger(ViewReligionService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                String resultJson = new ReligionManager().viewList();
