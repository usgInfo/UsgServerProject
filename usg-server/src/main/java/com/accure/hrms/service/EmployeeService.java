...
//                String employeeJson = request.getParameter("employeeJson");
                    ...
                    Type type = new TypeToken<com.accure.hrms.dto.Employee>() {
                    }.getType();
                    com.accure.hrms.dto.Employee employee = new Gson().fromJson(employeeJson, type);
                    employee.setImageAvailable(isImageAVailable);
                    String resultid = new EmployeeManager().save(employee, userId);
