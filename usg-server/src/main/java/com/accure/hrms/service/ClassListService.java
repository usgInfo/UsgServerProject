 ...
 * @author user
 */
public class ClassListService extends HttpServlet {
     Logger logger = Logger.getLogger(ClassListService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                String resultJson = new ClassManager().fetchAllClass();
