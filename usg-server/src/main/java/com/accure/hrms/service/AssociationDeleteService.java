 ...
 * @author user
 */
public class AssociationDeleteService extends HttpServlet {

    Logger logger = Logger.getLogger(AssociationDeleteService.class);
    String privilege = ApplicationConstants.PV_DELETE_ASSOCIATION;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new AssociationManager().delete(id, userid);
                ...
                logger.info(Common.getLogMsg("AssociationDeleteService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("AssociationDeleteService", ApplicationConstants.ERROR, stack.toString()));
