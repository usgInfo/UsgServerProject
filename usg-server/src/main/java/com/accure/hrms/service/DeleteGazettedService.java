 ...
 * @author accure
 */
public class DeleteGazettedService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_GAD_NONGAD;
    Logger logger = Logger.getLogger(DeleteGazettedService.class);
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new GAManager().delete(id, loginUserId);
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("DeleteGazettedService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("DeleteGazettedService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
            ...
            logger.error(Common.getLogMsg("DeleteGazettedService", ApplicationConstants.ERROR, stack.toString()));
