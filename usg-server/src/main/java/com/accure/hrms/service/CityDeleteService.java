 ...
 * @author user
 */
public class CityDeleteService extends HttpServlet {

    Logger logger = Logger.getLogger(CityDeleteService.class);
    String privilege = ApplicationConstants.PV_DELETE_CITY;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new CityManager().delete(id, userid);
                ...
                logger.info(Common.getLogMsg("DeleteCityService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("DeleteCityService", ApplicationConstants.ERROR, stack.toString()));
