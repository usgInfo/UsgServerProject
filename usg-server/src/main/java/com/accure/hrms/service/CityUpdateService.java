...
public class CityUpdateService extends HttpServlet {
    ...
    String privilege = ApplicationConstants.PV_UPDATE_CITY;
    /**
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String ddo = request.getParameter("updateJson");
                    String id = request.getParameter("id");
                String userid=request.getParameter("userid");

                String status = new CityManager().update(ddo,id,userid);
               ...
               if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("CityUpdateService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
            ...
            logger.error(Common.getLogMsg("CityUpdateService", ApplicationConstants.ERROR, stack.toString()));
