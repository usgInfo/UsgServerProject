 ...
 * @author user
 */
public class HeadAssignViewByDDOService extends HttpServlet {

    Logger logger = Logger.getLogger(HeadAssignViewByDDOService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                resultEmployeeJson = new Gson().toJson(new HeadAssignManager().searchItFinally(employeeSearch));
