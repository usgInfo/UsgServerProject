 ...
 * @author user
 */
public class GradeDeleteService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_GRADE;
Logger logger = Logger.getLogger(GradeDeleteService.class);
    /**
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new GradeManager().deleteGrade(id,userId);
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("GradeDeleteService", ApplicationConstants.VIEW, ApplicationConstants.FAIL));
                        ...
                        logger.info(Common.getLogMsg("GradeDeleteService", ApplicationConstants.VIEW, ApplicationConstants.DELETE_MESSAGE));
                    } else {
                        request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_INVALID_SESSION);
                        out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_INVALID_SESSION));
                        logger.info(Common.getLogMsg("GradeDeleteService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
                    }
                } else {
                    ...
                    logger.info(Common.getLogMsg("GradeDeleteService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
                request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_INVALID_SESSION);
                out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_INVALID_SESSION));
            ...
            logger.error(Common.getLogMsg("GradeDeleteService", ApplicationConstants.ERROR, stack.toString()));
