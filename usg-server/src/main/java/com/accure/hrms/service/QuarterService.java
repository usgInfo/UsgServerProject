 ...
 * @author user
 */
public class QuarterService extends HttpServlet {

    String privilege = ApplicationConstants.PV_CREATE_QUARTER;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String result = new QuarterManager().saveQuarter(quarter, userId);
