...
import com.accure.hrms.manager.ChapterVITypeManager;
 ...
 * @author Asif
 */
public class ChapterVITypeService extends HttpServlet {

    Logger logger = Logger.getLogger(ChapterVITypeService.class);
    String privilege = ApplicationConstants.PV_CREATE_CHAPTER_VI;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    //System.out.println("json objedt" + objJson);

                    Type type = new TypeToken<ChapterVIType>() {
                    }.getType();
                    ChapterVIType fc = new Gson().fromJson(objJson, type);
                    String result = new ChapterVITypeManager().save(fc, loginUserId);
                if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                    request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                    out.write(new Gson().toJson(result));
                    logger.info(Common.getLogMsg("ChapterVITypeUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                    ...
                    logger.info(Common.getLogMsg("ChapterVITypeUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("ChapterVITypeService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.INVALID_SESSION));
                }
            } else {
            ...
            logger.info(Common.getLogMsg("ChapterVITypeService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.HTTP_STATUS_EXCEPTION));
        } finally {
            out.close();
        }
    }
