 ...
 * @author user
 */
public class EmployeeDepartmentMappingUpdate extends HttpServlet {
//String privilege = ApplicationConstants.PV_UPDATE_EMPLOYEE_DEPARTMENT_MAPPING;

    Logger logger = Logger.getLogger(EmployeeDepartmentMappingUpdate.class);
    /**
...
//                if (authorized) {
                    ...
                    String userid = request.getParameter("userId");
                     ...
                     EmployeeDepartmentMapping empDeptObj=new Gson().fromJson(empDeptStr, new TypeToken<EmployeeDepartmentMapping>(){}.getType());
                     
                     
                    String status = new EmployeeDepartmentMappingManager().update(empDeptObj, userid, id);
                    ...
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("EmployeeDepartmentMappingUpdate", ApplicationConstants.UPDATE, ApplicationConstants.FAIL));
...
//                }
                ...
                logger.info(Common.getLogMsg("EmployeeDepartmentMappingUpdate", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        }
        catch (Exception ex) {
