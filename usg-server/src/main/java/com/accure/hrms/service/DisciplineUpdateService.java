 ...
 * @author user
 */
public class DisciplineUpdateService extends HttpServlet {

    Logger logger = Logger.getLogger(DisciplineUpdateService.class);
    String privilege = ApplicationConstants.PV_UPDATE_DISCIPLINE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String newSection = request.getParameter("disciplineName");
                    String id = request.getParameter("id");
                String userid=request.getParameter("userid");
                    DisciplineManager disManObj = new DisciplineManager();
                String status = disManObj.update(newSection, id,userid);
                ...
                if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("DisciplineUpdateService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
            ...
            logger.error(Common.getLogMsg("DisciplineUpdateService", ApplicationConstants.ERROR, stack.toString()));
