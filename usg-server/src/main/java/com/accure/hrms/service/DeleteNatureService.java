 ...
 * @author accure
 */
public class DeleteNatureService extends HttpServlet {

    Logger logger = Logger.getLogger(DeleteNatureService.class);
    String privilege = ApplicationConstants.PV_DELETE_NATURE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new NatureManager().delete(id, loginUserId);
                    ...
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("DeleteNatureService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("DeleteNatureService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
