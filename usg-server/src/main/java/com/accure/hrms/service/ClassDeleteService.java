 ...
 * @author user
 */
public class ClassDeleteService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_CLASS;
        ...
        /*try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    boolean result = new ClassManager().deleteClass(cId);
...
//                logger.info(Common.getLogMsg("ViewReligionService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                String status = new ClassManager().deleteClass(id,userId);
