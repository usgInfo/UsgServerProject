 ...
 * @author user
 */
public class FetchAllEmployeePriviousDetailsService extends HttpServlet {
        ...
        try {
           HttpSession session = request.getSession(false);
            if (SessionManager.checkUserSession(session)) {
                ...
                String resultJson = new EmployeePreviousJobDetailManager().fetchAllEmployeePriviousDetails(ddo);
