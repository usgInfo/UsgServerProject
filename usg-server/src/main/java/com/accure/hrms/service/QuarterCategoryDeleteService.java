 ...
 * @author user
 */
public class QuarterCategoryDeleteService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_QUARTER_CATEGORY;
    Logger logger = Logger.getLogger(QuarterCategoryDeleteService.class);
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new QuarterCategoryManager().deleteQuarterCategory(qId, userId);
                    ...
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("QuarterCategoryDeleteService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                        ...
                        logger.info(Common.getLogMsg("QuarterCategoryDeleteService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
                    }
                } else {
            ...
            logger.error(Common.getLogMsg("QuarterCategoryDeleteService", ApplicationConstants.ERROR, stack.toString()));
