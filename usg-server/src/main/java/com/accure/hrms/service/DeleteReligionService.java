 ...
 * @author upendra
 */
public class DeleteReligionService extends HttpServlet {

    Logger logger = Logger.getLogger(DeleteReligionService.class);
    String privilege = ApplicationConstants.PV_DELETE_RELIGION;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new ReligionManager().delete(id, loginUserId);
            ...
            logger.error(Common.getLogMsg("DeleteReligionService", ApplicationConstants.ERROR, stack.toString()));
