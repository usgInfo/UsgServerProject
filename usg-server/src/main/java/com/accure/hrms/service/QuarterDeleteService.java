 ...
 * @author user
 */
public class QuarterDeleteService extends HttpServlet {

    Logger logger = Logger.getLogger(QuarterDeleteService.class);
    String privilege = ApplicationConstants.PV_DELETE_QUARTER;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new QuarterManager().deleteQuarter(qId, userId);
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("QuarterDeleteService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("QuarterDeleteService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            ex.printStackTrace();
            ...
            logger.error(Common.getLogMsg("QuarterDeleteService", ApplicationConstants.ERROR, stack.toString()));
