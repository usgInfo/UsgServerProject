...
import com.accure.hrms.manager.AssociationManager;
 ...
 * @author user
 */
public class AssociationUpdateService extends HttpServlet {

    String privilege = ApplicationConstants.PV_UPDATE_ASSOCIATION;
Logger logger = Logger.getLogger(AssociationUpdateService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session))
            {
                ...
                if (authorized) 
                {
                String assJson = request.getParameter("assJson");
                Type type = new TypeToken<Association>() {
                }.getType();
                Association ass = new Gson().fromJson(assJson, type);
                String id = request.getParameter("id");
                String userid = request.getParameter("userid");
                String status = new AssociationManager().update(ass, id, userid);
                ...
                if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                    ...
                    out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_FAIL));
                        logger.info(Common.getLogMsg("AssociationUpdateService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                    ...
                    } else 
                    {
                        ...
                        logger.info(Common.getLogMsg("AssociationUpdateService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
                }
            ...
            logger.error(Common.getLogMsg("AssociationUpdateService", ApplicationConstants.ERROR, stack.toString()));
