 ...
 * @author upendra
 */
public class SaveEmpDemographicService extends HttpServlet {

    Logger logger = Logger.getLogger(SaveEmpDemographicService.class);
    String privilege = ApplicationConstants.PV_EMPLOYEE_DEMOGRAPHIC_CREATE;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                logger.info(Common.getLogMsg("SaveEmpDemographicService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("SaveEmpDemographicService", ApplicationConstants.ERROR, stack.toString()));
