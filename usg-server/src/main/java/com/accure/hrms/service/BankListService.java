...
public class BankListService extends HttpServlet {
      Logger logger = Logger.getLogger(BankListService.class);
       ...
       response.setContentType("text/json;charset=UTF-8");
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                String resultBankJson = new BankManager().fetchAllBank();
