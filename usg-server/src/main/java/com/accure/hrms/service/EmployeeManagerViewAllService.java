 ...
 * @author Asif
 */
public class EmployeeManagerViewAllService extends HttpServlet {

    Logger logger = Logger.getLogger(EmployeeManagerViewAllService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                String resultEmployeeJson = new EmployeeManager().fetchAll();
