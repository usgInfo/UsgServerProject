 ...
 * @author user
 */
public class DepartmentUpdateService extends HttpServlet {

    Logger logger = Logger.getLogger(DepartmentUpdateService.class);
    String privilege = ApplicationConstants.PV_UPDATE_DEPARTMENT;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = departmentObj.update(newDepartment, id, userid);
                ...
                logger.info(Common.getLogMsg("DepartmentUpdateService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("UpdateDepartmentService", ApplicationConstants.ERROR, stack.toString()));
