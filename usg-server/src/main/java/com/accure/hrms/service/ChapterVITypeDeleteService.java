 ...
 * @author Asif
 */
public class ChapterVITypeDeleteService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_CHAPTER_VI;
    Logger logger = Logger.getLogger(ChapterVITypeDeleteService.class);
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new ChapterVITypeManager().delete(Id, loginUserId);
                    ...
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("ChapterVITypeDeleteService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("ChapterVITypeDeleteService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("ChapterVITypeDeleteService", ApplicationConstants.ERROR, stack.toString()));
