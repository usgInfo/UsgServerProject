 ...
 * @author user
 */
public class BankUpdateService extends HttpServlet {
     Logger logger = Logger.getLogger(DAUpdateService.class);
    String privilege = ApplicationConstants.PV_UPDATE_BANK;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                Bank bank = new Gson().fromJson(bankJson, type);
                String bid = request.getParameter("bid");
                String userId = request.getParameter("userId");
                String status = new BankManager().updateBank(bank, bid,userId);
