...
public class AssociationService extends HttpServlet {
    ...
    String privilege = ApplicationConstants.PV_CREATE_ASSOCIATION;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    Association ass = new Gson().fromJson(classJson, type);
                    String result = new AssociationManager().save(ass, userid);
