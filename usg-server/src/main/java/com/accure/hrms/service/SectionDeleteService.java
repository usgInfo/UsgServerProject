 ...
 * @author user
 */
public class SectionDeleteService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_SECTION;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new SectionManager().delete(Id, userid);
