 ...
 * @author user
 */
public class DesignationDeleteService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_DESIGNATION;
    Logger logger = Logger.getLogger(DesignationDeleteService.class);
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new DesignationManager().delete(designationId, userId);
                    ...
                    logger.info(Common.getLogMsg("DesignationDeleteService", ApplicationConstants.VIEW, ApplicationConstants.FAIL));
                        ...
                        out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_DELETE_MAP));
                         logger.info(Common.getLogMsg("DesignationDeleteService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("DesignationDeleteService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("DesignationDeleteService", ApplicationConstants.ERROR, stack.toString()));
