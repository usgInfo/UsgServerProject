...
public class DeleteDdoService extends HttpServlet {
    ...
    String privilege = ApplicationConstants.PV_DELETE_DDO_DEPARTMENT_MAPPING;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new DDODepartmentManager().delete(id, userid);
                    ...
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("DeleteDdoService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
