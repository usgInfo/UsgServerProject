 ...
 * @author user
 */
public class ClassUpdateService extends HttpServlet {

String privilege = ApplicationConstants.PV_UPDATE_CLASS;
Logger logger = Logger.getLogger(CityUpdateService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) 
                {
                    String classJson = request.getParameter("classJson");
                    String userId = request.getParameter("userId");
                    Type type = new TypeToken<Class>() {
                    }.getType();
                    Class cla = new Gson().fromJson(classJson, type);
                String cId=request.getParameter("id");
                String status = new ClassManager().updateClass(cla, cId,userId);
               if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("ClassUpdateService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                    ...
                    } else 
                    {
                        ...
                        logger.info(Common.getLogMsg("ClassUpdateService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
                    }
