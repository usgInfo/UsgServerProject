 ...
 * @author user
 */
public class DesignationUpdateService extends HttpServlet {

     Logger logger = Logger.getLogger(DAUpdateService.class);
    String privilege = ApplicationConstants.PV_UPDATE_DESIGNATION;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                String status = new DesignationManager().update(designation, designationId,userId);
               if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("DesignationUpdateService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                    ...
                    } else 
                    {
                        ...
                        logger.info(Common.getLogMsg("DesignationUpdateService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
                    }
