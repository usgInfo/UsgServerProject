 ...
 * @author upendra
 */
public class DeleteFormulaService extends HttpServlet {

    Logger logger = Logger.getLogger(DeleteFormulaService.class);
    String privilege = ApplicationConstants.PV_DELETE_FORMULA;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new FormulaManager().deleteFormula(id, userid);
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("DeleteFormulaService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("DeleteFormulaService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("DeleteFormulaService", ApplicationConstants.ERROR, stack.toString()));
