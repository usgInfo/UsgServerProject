 ...
 * @author user
 */
public class EmployeeTransferFormViewAllService extends HttpServlet {

    Logger logger = Logger.getLogger(EmployeeTransferFormViewAllService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //   String location=request.getParameter("location");
                String resultEmployeeJson = new EmployeePromotionManager().fetchAllForEmployeeTransferform(ddo);
