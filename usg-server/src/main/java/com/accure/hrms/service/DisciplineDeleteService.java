 ...
 * @author user
 */
public class DisciplineDeleteService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_DISCIPLINE;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new DisciplineManager().delete(Id, userid);
