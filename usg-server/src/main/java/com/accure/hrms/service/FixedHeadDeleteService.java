 ...
 * @author Asif
 */
public class FixedHeadDeleteService extends HttpServlet {

    Logger logger = Logger.getLogger(FixedHeadDeleteService.class);
    String privilege = ApplicationConstants.PV_DELETE_FIXED_HEAD;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new FixedHeadManager().delete(Id, loginUserId);
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("FixedHeadDeleteService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("FixedHeadDeleteService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("FixedHeadDeleteService", ApplicationConstants.ERROR, stack.toString()));
