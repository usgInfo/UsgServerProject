 ...
 * @author user
 */
public class GISGroupMasterService extends HttpServlet {

    String privilege = ApplicationConstants.PV_CREATE_GIS_GROUP;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    String classJson = request.getParameter("gisgroupmaster");
                    String userid = request.getParameter("userid");
                    Type type = new TypeToken<GISGroup>() {
                    }.getType();
                    GISGroup cla = new Gson().fromJson(classJson, type);
                    String result = new GISGroupMasterManager().save(cla, userid);
