 ...
 * @author upendra
 */
public class DeleteRelationService extends HttpServlet {

    Logger logger = Logger.getLogger(DeleteRelationService.class);
    String privilege = ApplicationConstants.PV_DELETE_RELATION;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new RelationManager().delete(id, loginUserId);
                    ...
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("DeleteRelationService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                ...
                logger.info(Common.getLogMsg("DeleteReligionService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
            ...
            logger.error(Common.getLogMsg("DeleteRelationService", ApplicationConstants.ERROR, stack.toString()));
