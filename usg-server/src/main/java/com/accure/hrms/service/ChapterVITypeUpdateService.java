 ...
 * @author Asif
 */
public class ChapterVITypeUpdateService extends HttpServlet {

    Logger logger = Logger.getLogger(ChapterVITypeUpdateService.class);
    String privilege = ApplicationConstants.PV_UPDATE_CHAPTER_VI;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    ChapterVIType obj = new Gson().fromJson(objJson, type);
                    String Id = request.getParameter("Id");
                String result = new ChapterVITypeManager().update(obj, Id, userId);
                ...
                logger.info(Common.getLogMsg("ChapterVITypeUpdateService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.info(Common.getLogMsg("ChapterVITypeUpdateService", ApplicationConstants.ERROR, ApplicationConstants.HTTP_STATUS_EXCEPTION));
