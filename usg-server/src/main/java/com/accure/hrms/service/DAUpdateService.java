 ...
 * @author Shwetha T S
 */
public class DAUpdateService extends HttpServlet {

    Logger logger = Logger.getLogger(DAUpdateService.class);
    String privilege = ApplicationConstants.PV_UPDATE_DA_MA_RATE;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    String updateDa = request.getParameter("updateDAMaster");
                    String id = request.getParameter("id");
                    String userid = request.getParameter("userid");
                    //System.out.println("in the service da object" + updateDa);
                    //System.out.println("in the service object id" + id);
                    //System.out.println("in the service user id" + userid);
                    Type type = new TypeToken<DAMaster>() {
                    }.getType();
                    DAMaster cla = new Gson().fromJson(updateDa, type);
                    String status = new DAManager().updateDA(cla, id, userid);
                    ...
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("DAUpdateService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                    ...
                    } else 
                    {
                        ...
                        logger.info(Common.getLogMsg("DAUpdateService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
                    }
            ...
            logger.error(Common.getLogMsg("DAUpdateService", ApplicationConstants.ERROR, stack.toString()));
