 ...
 * @author user
 */
public class DepartmentDeleteService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_DEPARTMENT;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new DepartmentManager().delete(Id, userid);
