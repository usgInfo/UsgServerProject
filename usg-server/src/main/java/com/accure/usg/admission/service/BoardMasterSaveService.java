 ...
 * @author KC
 */
public class BoardMasterSaveService extends HttpServlet {

    Logger logger = Logger.getLogger(BoardMasterSaveService.class);
...
//                boolean authorized = UserManager.checkUserPrivilege(currentUser, privilege);
                boolean authorized = true;
                 if (authorized) {
                    ...
                    String result = new BoardManager().createBoard(board, loginId);
            ...
            out.write(new Gson().toJson(new Common().onFailure(ApplicationConstants.HTTP_STATUS_EXCEPTION, ApplicationConstants.BOARD_CREATION_FAILED, "")));
