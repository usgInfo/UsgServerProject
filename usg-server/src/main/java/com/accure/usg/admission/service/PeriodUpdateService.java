 ...
 * @author Shwetha T S
 */
public class PeriodUpdateService extends HttpServlet {

    Logger logger = Logger.getLogger(PeriodUpdateService.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                String result = new PeriodManager().updatePeriod(loginUserId, primaryKey, period);

                if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                    request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_SUCCESS);
                    out.write(new Gson().toJson(result));
                    logger.info(Common.getLogMsg("PeriodUpdateService", ApplicationConstants.UPDATE, ApplicationConstants.SUCCESS));
                    ...
                    out.write(new Gson().toJson(result));
                    logger.info(Common.getLogMsg("PeriodUpdateService", ApplicationConstants.UPDATE, ApplicationConstants.FAIL));
                } else {
...
//                }
                ...
                logger.info(Common.getLogMsg("PeriodUpdateService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
            ...
            logger.error(Common.getLogMsg("PeriodUpdateService", ApplicationConstants.ERROR, stack.toString()));
