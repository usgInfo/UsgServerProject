...
import com.accure.usg.admission.manager.BoardManager;
 ...
 * @author KC
 */
public class BoardMasterDeleteService extends HttpServlet {

    Logger logger = Logger.getLogger(BoardMasterDeleteService.class);
    /**
...
//                boolean authorized = UserManager.checkUserPrivilege(currentUser, privilege);
                boolean authorized = true;
                    ...
                    String status = new BoardManager().deleteBoardMaster(id, userId);
