 ...
 * @author user
 */
public class SearchPreviousEmployeeDetailsByEmployeeCodeService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                String result = new EmployeePreviousJobDetailManager().getEmployeeByEmployeeCode(cId);
                if (result !=null ) {
