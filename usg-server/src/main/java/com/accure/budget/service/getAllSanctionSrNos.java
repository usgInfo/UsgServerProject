 ...
 * @author user
 */
public class getAllSanctionSrNos extends HttpServlet {
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                String obj = request.getParameter("obj");
                 Type type = new TypeToken<SanctionUniversityIncomeBudget>() {}.getType();
                SanctionUniversityIncomeBudget createIncomeBudgetObj = new Gson().fromJson(obj, type);
                SanctionUniversityIncomeBudgetManager asstn = new SanctionUniversityIncomeBudgetManager();
