 ...
 * @author accure
 */
public class LocationwiseIncomeDelete extends HttpServlet {
 Logger logger = Logger.getLogger(LocationwiseIncomeDelete.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                User currentUser = (User) session.getAttribute("user");
                    ...
                    if (result == true) {
                        ...
                        logger.info(Common.getLogMsg("LocationwiseIncomeDelete", ApplicationConstants.VIEW, ApplicationConstants.SUCCESS));
                    } else {
            ...
            logger.error(Common.getLogMsg("LocationwiseIncomeDelete", ApplicationConstants.ERROR, stack.toString()));
