 ...
 * @author accure
 */
public class LedgerAsPerBudgetService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                List<Map<String, String>> resultJson = new LedgerCodeManager().fetchAllLedgerForBudget();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(LedgerAsPerBudgetService.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
