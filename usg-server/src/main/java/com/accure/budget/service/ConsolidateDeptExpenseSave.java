 ...
 * @author upendra
 */
public class ConsolidateDeptExpenseSave extends HttpServlet {

    Logger logger = Logger.getLogger(ConsolidateDeptExpenseSave.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    if (result != null && !result.isEmpty()) {
                        ...
                        logger.info(Common.getLogMsg("ConsolidateDeptExpenseSave", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                    } else {
                ...
                logger.info(Common.getLogMsg("ConsolidateDeptExpenseSave", ApplicationConstants.AUTHENTICATION, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            ...
            logger.info(Common.getLogMsg("ConsolidateDeptExpenseSave", ApplicationConstants.AUTHENTICATION, ApplicationConstants.HTTP_STATUS_EXCEPTION));
        } finally {
            out.close();
        }
    }
