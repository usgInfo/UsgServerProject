 ...
 * @author user
 */
public class BudgetFinanceYearDeleteService extends HttpServlet {

    Logger logger = Logger.getLogger(BudgetFinanceYearDeleteService.class);
    String privilege = ApplicationConstants.PV_DELETE_FINANCIAL_YEAR;
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String status = new FinancialYearManager().delete(id);
                    ...
                    if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("BudgetFinanceYearDeleteService", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
                        ...
                        logger.info(Common.getLogMsg("BudgetFinanceYearDeleteService", ApplicationConstants.DELETE, ApplicationConstants.UNAUTHORIZED_ACCESS));
                    }
                } else {
                    request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_INVALID_SESSION);
                    out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_INVALID_SESSION));
                    logger.info(Common.getLogMsg("BudgetFinanceYearDeleteService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
                }
            }
        } catch (Exception ex) {
            ex.printStackTrace();
            ...
            logger.error(Common.getLogMsg("BudgetFinanceYearDeleteService", ApplicationConstants.ERROR, stack.toString()));
