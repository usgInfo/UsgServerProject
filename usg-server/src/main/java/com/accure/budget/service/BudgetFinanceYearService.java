 ...
 * @author user
 */
public class BudgetFinanceYearService extends HttpServlet {

    Logger logger = Logger.getLogger(BudgetFinanceYearService.class);
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    String fyJson = request.getParameter("financialYear");
                    String userid = request.getParameter("userId");
                    Type type = new TypeToken<FinancialYear>() {
                    }.getType();
                    FinancialYear fyObj = new Gson().fromJson(fyJson, type);
                    ...
                    if (result.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                        ...
                        logger.info(Common.getLogMsg("BudgetFinanceYearService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.SUCCESS));
                        ...
                        logger.info(Common.getLogMsg("BudgetFinanceYearService", ApplicationConstants.AUTHENTICATION, ApplicationConstants.FAIL));
                    ...
                    logger.info(Common.getLogMsg("BudgetFinanceYearService", ApplicationConstants.DELETE, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
                request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_INVALID_SESSION);
                out.write(new Gson().toJson(ApplicationConstants.HTTP_STATUS_INVALID_SESSION));
                logger.info(Common.getLogMsg("BudgetFinanceYearService", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
            request.setAttribute("statuscode", ApplicationConstants.HTTP_STATUS_EXCEPTION);
            StringWriter stack = new StringWriter();
            ex.printStackTrace(new PrintWriter(stack));
            logger.error(Common.getLogMsg("BudgetFinanceYearService", ApplicationConstants.ERROR, stack.toString()));
