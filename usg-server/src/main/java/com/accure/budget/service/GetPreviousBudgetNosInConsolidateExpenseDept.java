 ...
 * @author accure
 */
public class GetPreviousBudgetNosInConsolidateExpenseDept extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ConsolidateDepartmentExpence createIncomeBudgetObj = new Gson().fromJson(obj, type);
            ConsolidateDeptExpenseManager assten = new ConsolidateDeptExpenseManager();
