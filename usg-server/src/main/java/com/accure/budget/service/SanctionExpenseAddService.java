        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    int count = list.size();
                    String result = "";
                    String srNo = new SanctionUniversityExpenseBudgetManager().getSlNumber(finyear,fundType,sector,budgetHead);
                    ...
                    logger.info(Common.getLogMsg("SanctionExpenseAddService", ApplicationConstants.FAIL, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
