 ...
 * @author accure
 */
public class GetLedgersPreviousBudgetAmount extends HttpServlet {
...
//            if (SessionManager.checkUserSession(session)) {
            ...
            String resultJson = asstn.getLedgersBasedOnHeads(fundType, budgetHead, budgetType, ddo, location, financialYear, sector, department,type);
