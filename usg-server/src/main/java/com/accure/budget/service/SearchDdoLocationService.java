 ...
 * @author user
 */
public class SearchDdoLocationService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            if (SessionManager.checkUserSession(session)) {
                String ddo_id=request.getParameter("_id");
                String resultJson = new EmployeeManager().fetchEmployeeLocation(ddo_id);
