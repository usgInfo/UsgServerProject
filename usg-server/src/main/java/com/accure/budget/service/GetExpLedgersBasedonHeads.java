 ...
 * @author user
 */
public class GetExpLedgersBasedonHeads extends HttpServlet {
...
//            if (SessionManager.checkUserSession(session)) {
                ...
                String resultJson = asstn.getLedgersBasedOnHeads(fundType, budgetHead, budgetType, location, finacialYear, ddo,department);
