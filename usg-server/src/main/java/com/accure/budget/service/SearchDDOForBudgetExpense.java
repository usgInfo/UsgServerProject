...
// * @author user
// */
//public class SearchDDOForBudgetExpense extends HttpServlet {
//Logger logger = Logger.getLogger(SearchDDOForBudgetExpense.class);
//    /**
...
//
//                BudgetExpenseManager section = new BudgetExpenseManager();
//                String resultJson = section.Create(ddo, fundType, sector);
//
