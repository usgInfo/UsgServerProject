 ...
 * @author user
 */
public class BudgetFundTypeDeleteService extends HttpServlet {

    Logger logger = Logger.getLogger(BudgetFundTypeDeleteService.class);
    String privilege = ApplicationConstants.PV_DELETE_FUND_TYPE;
...
//                boolean status = new FundTypeManager().delete(id);
                    String status = new FundTypeManager().deleteFundType(id, currentUserId);
                    ...
                    logger.info(Common.getLogMsg("BudgetFundTypeDeleteService", ApplicationConstants.DELETE, ApplicationConstants.UNAUTHORIZED_ACCESS));
                }
            } else {
            ...
            logger.error(Common.getLogMsg("BudgetFundTypeDeleteService", ApplicationConstants.ERROR, stack.toString()));
