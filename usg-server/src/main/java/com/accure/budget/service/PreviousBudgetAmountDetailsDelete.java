 ...
 * @author user
 */
public class PreviousBudgetAmountDetailsDelete extends HttpServlet {
//String privilege = ApplicationConstants.PV_DELETE_PARTY_MASTER;
    Logger logger = Logger.getLogger(PreviousBudgetAmountDetailsDelete.class);
...
//                if (authorized) {
                ...
                String status = new PreviousBudgetAmountDetailsManager().Delete(id,userid);
              ...
              if (status.equalsIgnoreCase(ApplicationConstants.SUCCESS)) {
                    ...
                    logger.info(Common.getLogMsg("PreviousBudgetAmountDetailsDelete", ApplicationConstants.DELETE, ApplicationConstants.FAIL));
...
//                }
                ...
                logger.info(Common.getLogMsg("PreviousBudgetAmountDetailsDelete", ApplicationConstants.FAIL, ApplicationConstants.INVALID_SESSION));
            }
        } catch (Exception ex) {
