 ...
 * @author upendra
 */
public class ConsolidateDepartmentExpence extends Common {
    ...
    private String consolidateDeptExpenseId;
    ...
    public String getConsolidateDeptExpenseId() {
        return consolidateDeptExpenseId;
    }

    public void setConsolidateDeptExpenseId(String consolidateDeptExpenseId) {
        this.consolidateDeptExpenseId = consolidateDeptExpenseId;
    }
}
