 ...
 * @author accure
 */
public class LocationBasedOnLocationService extends HttpServlet {

    Logger logger = Logger.getLogger(LocationBasedOnLocationService.class);
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                locationList = new DDOLocationManager().fetchAllLocation(ddoId);
