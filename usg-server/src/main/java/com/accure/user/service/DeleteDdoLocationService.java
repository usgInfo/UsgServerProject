 ...
 * @author accure
 */
public class DeleteDdoLocationService extends HttpServlet {

    String privilege = ApplicationConstants.PV_DELETE_DDO_LOCATION_MAPPING;
        ...
        /*try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    ...
                    boolean result = new DDOLocationManager().delete(id);
...
//                String status = new BankManager().deleteBank(id, currentUserLogin);
                String status = new DDOLocationManager().deleteDDOLocation(id);
