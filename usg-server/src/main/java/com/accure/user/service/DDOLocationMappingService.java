 ...
 * @author accure
 */
public class DDOLocationMappingService extends HttpServlet {

    Logger logger = Logger.getLogger(DDOLocationMappingService.class);
    String privilege = ApplicationConstants.PV_CREATE_DDO_LOCATION_MAPPING;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (SessionManager.checkUserSession(session)) {
                ...
                if (authorized) {
                    String ddoJson = request.getParameter("ddoJson");
                    String userid = request.getParameter("userid");
                    DdoLocationMap list = new Gson().fromJson(ddoJson, new TypeToken<DdoLocationMap>() {
                    }.getType());
                    String result = null;

                    result = new DDOLocationManager().save(list, userid);
